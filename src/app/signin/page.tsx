...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      {/* Right Panel - Clean Product Preview (40%) */}
      <div className="flex-[2] bg-gray-50 flex flex-col justify-center items-center p-12">
        <FadeIn delay={600}>
          <div className="text-center max-w-md">
            ...
            <p className="text-gray-600 mb-8 text-lg leading-relaxed">
              Scale your outreach with AI-powered sequences and connect with prospects faster than ever.
            </p>
            ...
            {/* Simple CTA */}
            <button className="w-full text-white font-semibold py-4 px-6 rounded-lg transition-all duration-200 hover:shadow-lg" style={{ backgroundColor: '#1876d3' }}>
              Start Free Trial
            </button>
